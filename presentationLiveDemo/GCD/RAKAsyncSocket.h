...
@class RAKAsyncReadPacket;
@class RAKAsyncWritePacket;
@class RAKAsyncSocketPreBuffer;

extern NSString *const RAKAsyncSocketException;
extern NSString *const RAKAsyncSocketErrorDomain;

extern NSString *const RAKAsyncSocketQueueName;
extern NSString *const RAKAsyncSocketThreadName;

extern NSString *const RAKAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const RAKAsyncSocketUseCFStreamForTLS;
#endif
#define RAKAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define RAKAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define RAKAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const RAKAsyncSocketSSLPeerID;
extern NSString *const RAKAsyncSocketSSLProtocolVersionMin;
extern NSString *const RAKAsyncSocketSSLProtocolVersionMax;
extern NSString *const RAKAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const RAKAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const RAKAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const RAKAsyncSocketSSLDiffieHellmanParameters;
#endif

#define RAKAsyncSocketLoggingContext 65535


enum RAKAsyncSocketError
{
	RAKAsyncSocketNoError = 0,           // Never used
	RAKAsyncSocketBadConfigError,        // Invalid configuration
	RAKAsyncSocketBadParamError,         // Invalid parameter was passed
	RAKAsyncSocketConnectTimeoutError,   // A connect operation timed out
	RAKAsyncSocketReadTimeoutError,      // A read operation timed out
	RAKAsyncSocketWriteTimeoutError,     // A write operation timed out
	RAKAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	RAKAsyncSocketClosedError,           // The remote peer closed the connection
	RAKAsyncSocketOtherError,            // Description provided in userInfo
};
typedef enum RAKAsyncSocketError RAKAsyncSocketError;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

@interface RAKAsyncSocket : NSObject

/**
 * RAKAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, RAKAsyncSocket will automatically create it's own socket queue.
 ...
 * 
 * For accepting incoming connections, this means RAKAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means RAKAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, RAKAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, RAKAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of RAKAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a RAKAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a RAKAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that RAKAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - RAKAsyncSocketManuallyEvaluateTrust
 ...
 *     So RAKAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - RAKAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default RAKAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct RAKAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, RAKAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by RAKAsyncSocket,
 ...
 *
 * - RAKAsyncSocketSSLProtocolVersionMin
 * - RAKAsyncSocketSSLProtocolVersionMax
 ...
 *
 * - RAKAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see RAKAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use RAKAsyncSocketSSLProtocolVersionMin & RAKAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * RAKAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * This is because the RAK API offers no mechanism to discover a queue's targetQueue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(RAKAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(RAKAsyncSocket *)sock didAcceptNewSocket:(RAKAsyncSocket *)newSocket
 * {
 ...
 *   The faster and more powerful RAK API isn't notified properly in this case.
 * 
 ...
 * Example usage:
 * 
 * - (void)socket:(RAKAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol RAKAsyncSocketDelegate
@optional
...
**/
- (void)socket:(RAKAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(RAKAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(RAKAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(RAKAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(RAKAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(RAKAsyncSocket *)sock;
 ...
 * 
 * Note: If the RAKAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(RAKAsyncSocket *)sock withError:(NSError *)err;
...
**/
- (void)socket:(RAKAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
