...
//    _titleLabel.text = NSLocalizedString(@"disclaimer", nil);
    _titleLabel.text = @"Disclaimer";
    ...
    disclaimerLabel = [[UITextView alloc] initWithFrame:CGRectMake(diff_x,_topBg.frame.size.height+_topBg.frame.origin.y, viewW-2*diff_x, viewH-_topBg.frame.size.height-_topBg.frame.origin.y)];
    disclaimerLabel.scrollEnabled = YES;
    disclaimerLabel.editable = NO;
    disclaimerLabel.backgroundColor=[UIColor clearColor];
    [disclaimerLabel setTextAlignment:NSTextAlignmentLeft];
    [disclaimerLabel setContentMode:UIViewContentModeTopLeft];
    disclaimerLabel.text = NSLocalizedString(@"disclaimer_content", nil);
