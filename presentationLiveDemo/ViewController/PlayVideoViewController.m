...
- (void)viewDidLoad {
    ...
    [playVideoBack setImage:[UIImage imageNamed:@"nav_icon_back_pre@3x.png"] forState:UIControlStateNormal];
    [playVideoBack setTitleColor:[UIColor lightGrayColor]forState:UIControlStateNormal];
