...
//    [_passwordView  addSubview:_passwordImg];
    ...
    _ssidLabel= [[UILabel alloc] initWithFrame:CGRectMake(viewW*10/totalWeight, 0, viewW*110/totalWeight, viewH*40/totalHeight)];
    _ssidLabel.text = NSLocalizedString(@"password_ssid_label", nil);
    _ssidLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _ssidLabel.textAlignment=UITextAlignmentCenter;
    _ssidLabel.numberOfLines = 0;
    [_ssidView addSubview:_ssidLabel];
    ...
    _ssidText.frame=CGRectMake(viewW*154/totalWeight,0, viewW*180/totalWeight, viewH*40/totalHeight);
    _ssidText.backgroundColor = [UIColor whiteColor];
    _ssidText.enabled=NO;
    _ssidText.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _ssidText.placeholder=NSLocalizedString(@"password_ssid_hint", nil);
    _ssidText.delegate=self;
    [_ssidView addSubview:_ssidText];
    ...
    _ssidImg.frame = CGRectMake(viewW*301/totalWeight, 0, viewH*44/totalHeight, viewH*44/totalHeight);
    _ssidImg.contentMode=UIViewContentModeScaleToFill;
    [_ssidView addSubview:_ssidImg];
    ...
    _initPasswordLabel= [[UILabel alloc] initWithFrame:CGRectMake(viewW*10/totalWeight, 0, viewW*120/totalWeight, viewH*40/totalHeight)];
    _initPasswordLabel.text = NSLocalizedString(@"password_initial_label", nil);
    _initPasswordLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _initPasswordLabel.textAlignment=UITextAlignmentCenter;
    _initPasswordLabel.numberOfLines = 0;
    [_initPasswordView addSubview:_initPasswordLabel];
    ...
    _initPasswordImg.frame = CGRectMake(viewW*301/totalWeight, 0, viewH*44/totalHeight, viewH*44/totalHeight);
    _initPasswordImg.contentMode=UIViewContentModeScaleToFill;
    [_initPasswordView addSubview:_initPasswordImg];
    
    _initPasswordText=[[UITextField alloc]init];
    _initPasswordText.frame=CGRectMake(viewW*154/totalWeight,0, viewW*147/totalWeight, viewH*40/totalHeight);
    _initPasswordText.backgroundColor = [UIColor whiteColor];
    _initPasswordText.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    [_initPasswordView addSubview:_initPasswordText];
    ...
    _newPasswordLabel= [[UILabel alloc] initWithFrame:CGRectMake(viewW*10/totalWeight, 0, viewW*110/totalWeight, viewH*40/totalHeight)];
    _newPasswordLabel.text = NSLocalizedString(@"password_new_label", nil);
    _newPasswordLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _newPasswordLabel.backgroundColor = [UIColor clearColor];
    _newPasswordLabel.textColor = MAIN_COLOR;
    _newPasswordLabel.lineBreakMode = UILineBreakModeWordWrap;
    _newPasswordLabel.textAlignment=UITextAlignmentCenter;
    _newPasswordLabel.numberOfLines = 0;
    [_newPasswordView addSubview:_newPasswordLabel];
    ...
    _newPasswordImg.frame = CGRectMake(viewW*301/totalWeight, 0, viewH*44/totalHeight, viewH*44/totalHeight);
    _newPasswordImg.contentMode=UIViewContentModeScaleToFill;
    [_newPasswordView addSubview:_newPasswordImg];
    
    _newPasswordText=[[UITextField alloc]init];
    _newPasswordText.frame=CGRectMake(viewW*154/totalWeight,0, viewW*147/totalWeight, viewH*40/totalHeight);
    _newPasswordText.backgroundColor = [UIColor whiteColor];
    _newPasswordText.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    [_newPasswordView addSubview:_newPasswordText];
    ...
    _confirmLabel= [[UILabel alloc] initWithFrame:CGRectMake(viewW*10/totalWeight, 0, viewW*110/totalWeight, viewH*40/totalHeight)];
    _confirmLabel.text = NSLocalizedString(@"password_confirm_label", nil);
    _confirmLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _confirmLabel.backgroundColor = [UIColor clearColor];
    _confirmLabel.textColor = MAIN_COLOR;
    _confirmLabel.lineBreakMode = UILineBreakModeWordWrap;
    ...
    _confirmPasswordImg.frame = CGRectMake(viewW*301/totalWeight, 0, viewH*44/totalHeight, viewH*44/totalHeight);
    _confirmPasswordImg.contentMode=UIViewContentModeScaleToFill;
    [_confirmView addSubview:_confirmPasswordImg];
    
    _confirmText=[[UITextField alloc]init];
    _confirmText.frame=CGRectMake(viewW*154/totalWeight,0, viewW*147/totalWeight, viewH*40/totalHeight);
    _confirmText.backgroundColor = [UIColor whiteColor];
    _confirmText.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    [_confirmView addSubview:_confirmText];

    //Forget
    _passwordForgetBtn=[UIButton buttonWithType:UIButtonTypeCustom];
    _passwordForgetBtn.frame = CGRectMake(viewW*210/totalWeight, _confirmView.frame.size.height+_confirmView.frame.origin.y+viewH*13/totalHeight, viewW*150/totalWeight, viewH*21/totalHeight);
    [_passwordForgetBtn setTitle: NSLocalizedString(@"password_forget_label", nil) forState: UIControlStateNormal];
    _passwordForgetBtn.titleLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    [_passwordForgetBtn setTitleColor:[UIColor colorWithRed:180/255.0 green:181/255.0 blue:186/255.0 alpha:1.0]forState:UIControlStateNormal];
    ...
    _passwordModifyBtn.frame = CGRectMake(viewW*30/totalWeight, viewH-viewH*85/totalHeight-_topBg.frame.origin.y-_topBg.frame.size.height, viewW*316/totalWeight, viewH*44/totalHeight);
    ...
    _passwordModifyBtn.titleLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _videoImg.frame = CGRectMake(0, 0, viewW, viewH*180/totalHeight);
    ...
    _viewBtn.frame=CGRectMake(0, viewH*180/totalHeight, viewW, viewH*127/totalHeight);
    _viewBtn.backgroundColor=[UIColor whiteColor];
    [_videoView  addSubview:_viewBtn];
    
    _videoParametersLabel= [[UILabel alloc] initWithFrame:CGRectMake(0, viewH*7/totalHeight, viewW, viewH*20/totalHeight)];
    ...
    _videoParametersLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoParametersLabel.backgroundColor = [UIColor clearColor];
    _videoParametersLabel.textColor = [UIColor colorWithRed:180/255.0 green:181/255.0 blue:186/255.0 alpha:1.0];
    _videoParametersLabel.lineBreakMode = UILineBreakModeWordWrap;
    _videoParametersLabel.textAlignment=UITextAlignmentCenter;
    _videoParametersLabel.numberOfLines = 0;
    [_viewBtn addSubview:_videoParametersLabel];
    ...
    _videoModifyBtn.frame = CGRectMake(viewW*30/totalWeight, viewH-viewH*65/totalHeight-_topBg.frame.origin.y-_topBg.frame.size.height, viewW*316/totalWeight, viewH*44/totalHeight);
    ...
    _videoModifyBtn.titleLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _videoParametersView.frame=CGRectMake(0,viewH*308/totalHeight, viewW, viewH*206/totalHeight);
    _videoParametersView.backgroundColor=[UIColor whiteColor];
    ...
    _videoResolutionLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _videoResolutionSlider.thumbTintColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    _videoResolutionSlider.minimumTrackTintColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    ...
    _videoResolutionMinLabel=[[UILabel alloc] initWithFrame:CGRectMake(_videoResolutionLabel.frame.size.width+_videoResolutionLabel.frame.origin.x+viewH*22/totalHeight, viewH*35/totalHeight, viewH*44/totalHeight, viewH*18/totalHeight)];
    _videoResolutionMinLabel.text = NSLocalizedString(@"video_480p", nil);
    _videoResolutionMinLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoResolutionMinLabel.backgroundColor = [UIColor clearColor];
    _videoResolutionMinLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    ...
    _videoResolutionMaxLabel=[[UILabel alloc] initWithFrame:CGRectMake(viewW-viewH*66/totalHeight, viewH*35/totalHeight, viewH*50/totalHeight, viewH*18/totalHeight)];
    _videoResolutionMaxLabel.text = NSLocalizedString(@"video_1080p", nil);
    _videoResolutionMaxLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoResolutionMaxLabel.backgroundColor = [UIColor clearColor];
    _videoResolutionMaxLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    ...
    _videoResolutionValueLabel= [[UILabel alloc] initWithFrame:CGRectMake(viewW*275/totalWeight, viewH*35/totalHeight, viewW*44/totalWeight, viewH*18/totalHeight)];
    ...
    _videoRateLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    ...
    _videoRateMinLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoRateMinLabel.backgroundColor = [UIColor clearColor];
    _videoRateMinLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    ...
    _videoFrameRateMinLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoFrameRateMinLabel.backgroundColor = [UIColor clearColor];
    _videoFrameRateMinLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
...
- (void)set480P{
    ...
    _videoResolutionValueLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    _videoResolutionMaxLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    _videoResolutionMinLabel.font = [UIFont systemFontOfSize: viewH*20/totalHeight*0.8];
    _videoResolutionValueLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoResolutionMaxLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
...
- (void)set1080P{
    ...
    _videoResolutionMinLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    _videoResolutionValueLabel.textColor = [UIColor colorWithRed:67/255.0 green:69/255.0 blue:83/255.0 alpha:1.0];
    _videoResolutionMaxLabel.font = [UIFont systemFontOfSize: viewH*20/totalHeight*0.8];
    _videoResolutionMinLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoResolutionValueLabel.font = [UIFont systemFontOfSize: viewH*18/totalHeight*0.8];
    _videoResolutionMinImg.hidden=NO;
...
-(void)_videoBtnClick:(UIButton *)button
{
    [_smoothBtn setBackgroundImage:[UIImage imageNamed:@"configure_setting_button_nor@3x.png"] forState:UIControlStateNormal];
    [_smoothBtn setTitleColor:[UIColor colorWithRed:142/255.0 green:143/255.0 blue:152/255.0 alpha:1.0] forState:UIControlStateNormal];
    [_goodBtn setBackgroundImage:[UIImage imageNamed:@"configure_setting_button_nor@3x.png"] forState:UIControlStateNormal];
