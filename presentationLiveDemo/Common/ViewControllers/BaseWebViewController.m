...
- (void)setupWebViewBackButtonNavigationBar {
    UIButton *backBtn = [self setupNavigationBarButton:NavigationButtonStyleBack target:self aciton:@selector(closeGoBackTapped) sidePosition:ButtonInLeftNavigationBar];
...
- (void)dealloc {
    [_webView removeObserver:self forKeyPath:KVOWebProgressKey];
