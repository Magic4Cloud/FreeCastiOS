...
extern NSString *const RAKAsyncUdpSocketException;
extern NSString *const RAKAsyncUdpSocketErrorDomain;

extern NSString *const RAKAsyncUdpSocketQueueName;
extern NSString *const RAKAsyncUdpSocketThreadName;

enum RAKAsyncUdpSocketError
{
	RAKAsyncUdpSocketNoError = 0,          // Never used
	RAKAsyncUdpSocketBadConfigError,       // Invalid configuration
	RAKAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	RAKAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	RAKAsyncUdpSocketClosedError,          // The socket was closed
	RAKAsyncUdpSocketOtherError,           // Description provided in userInfo
};
typedef enum RAKAsyncUdpSocketError RAKAsyncUdpSocketError;
 ...
 * Example:
 * 
 * RAKAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^RAKAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id *context);
 ...
 *
**/
typedef BOOL (^RAKAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface RAKAsyncUdpSocket : NSObject

/**
 * RAKAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, RAKAsyncSocket will automatically create its own socket queue.
 ...
 * 
 * This means RAKAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, RAKAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, RAKAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, RAKAsyncUdpSocket will automatically use IPv6.
 ...
 * 
 * Since the OS/RAK notifies us of the size of each received UDP packet,
 ...
 * This is due to the fact that RAKAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about RAKAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(RAKAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(RAKAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * RAKAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, RAKAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about RAKAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(RAKAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(RAKAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The RAKAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally RAKAsyncUdpSocket doesn't use CFStream. (It uses the faster RAK API's.)
...
@protocol RAKAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(RAKAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(RAKAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(RAKAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(RAKAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(RAKAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(RAKAsyncUdpSocket *)sock withError:(NSError *)error;
