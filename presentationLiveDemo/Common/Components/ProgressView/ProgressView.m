...
- (void)addCenterLabel{
    ...
    UIColor *arcColor = [UIColor  colorWithRed:233/255.0 green:82/255.0 blue:25/255.0 alpha:1.0];;
    if (_percent >= 1) {
        percent = @"100%";
        fontSize = title_size;
    ...
    [percent drawInRect:CGRectMake(5, (viewSize.height*0.5-fontSize/2), viewSize.width-10, fontSize)withAttributes:attributes];
}
