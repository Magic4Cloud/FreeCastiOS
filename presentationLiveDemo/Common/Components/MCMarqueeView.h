...
typedef NS_ENUM(NSInteger, MCMarqueeSpeedLevel) {
    MCMarqueeSpeedLevelFast       = 2,
    MCMarqueeSpeedLevelMediumFast = 4,
    MCMarqueeSpeedLevelMediumSlow = 6,
    MCMarqueeSpeedLevelSlow       = 8,
};

@interface MCMarqueeView : CoreUIView
/**
 *  style is default, backgroundColor is white,textColor is black;
 *
 *  @param speed you can set 2,4,6,8.  smaller is faster
 *
 *  @return MCMarqueeView object
 */
