...
#define showAlert(_msg){UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Indicator" message:_msg delegate:nil cancelButtonTitle:nil otherButtonTitles:@"OK",nil];[alert show];}
